...
function callTelegramApi(endpoint: TelegramEndpoint, options: any): GoogleAppsScript.URL_Fetch.HTTPResponse {
  const telegram = new Telegram();
  return UrlFetchApp.fetch(telegram.apiBaseUrl + "/" + endpoint, options)
}
